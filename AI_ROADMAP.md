...
- Visible app candidate: **2026.09.18-FINAL.19** (per-machine vehicle bring recommendation opt-in maintenance; Analytics engine **AN14B3B4**, DB/schema remain 4).
