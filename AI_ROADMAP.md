...
- Visible app candidate: **2026.09.18-FINAL.20** (same-visit OCR continuation + automatic OCR-start maintenance; Analytics engine **AN14B3B5**, DB/schema remain 4).
