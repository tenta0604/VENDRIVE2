...
try{
  ...
  const draft=await ev(c,`(async()=>{
    ...
    const review={image:{name:"receipt.jpg",mime:"image/jpeg",size:1000,lastModified:null,stored:false,previewOnly:true},ocr:{provider:"google-gemini-api",requestId:"ops-gate",imageStored:false,rawTextStored:false,warnings:[]},classification:{detectedType:"input_recovery",selectedType:null,effectiveType:"input_recovery",typeConfidence:1},identity:{occurredAt:"2026-09-16T08:38:00+09:00",makerKey:"suntory",vendorNumber:"4038404",machineId:"M1"},candidatePayload:{input:{paper:{carNumber:"404",operatorName:"op",locationName:"loc"},totalQty:3,items:[{productCode:"705904",printedName:"sample",temperature:"COLD",column:null,quantity:3}]},recovery:{paper:{carNumber:"404",operatorName:"op",locationName:"loc"},totalQty:1,items:[{productCode:"744533",printedName:"sample2",temperature:"COLD",column:null,caseCount:0,looseCount:1,quantity:1}]}},candidateValidation:{structureReady:true},machineMatch:{status:"confirmed_mapping",confirmedMapping:{machineId:"M1",missing:false},candidates:[]}};
